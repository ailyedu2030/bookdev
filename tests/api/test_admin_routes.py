...
class TestListUsers:
    ...
    def test_list_users_with_data(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_list_users_filter_by_role(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_list_users_search(self, test_client, test_db, test_admin_authenticated):
...
class TestCreateUser:
    ...
    def test_create_user_success(self, mock_hash, test_client, test_db, test_admin_authenticated):
    ...
    def test_create_user_duplicate_email(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_create_user_viewer_forbidden(self, test_client, test_user_authenticated):
...
class TestGetUser:
    ...
    def test_get_user_success(self, test_client, test_db, test_admin_authenticated):
...
class TestUpdateUser:
    ...
    def test_update_user_success(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_update_user_no_data(self, test_client, test_db, test_admin_authenticated):
...
class TestDeleteUser:
    ...
    def test_delete_user_success(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_delete_user_cannot_delete_self(self, test_client, test_db, test_admin_authenticated):
...
class TestUpdateUserRole:
    ...
    def test_update_user_role_success(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_update_user_role_cannot_modify_self(self, test_client, test_db, test_admin_authenticated):
...
class TestListRoles:
    ...
    def test_list_roles_success(self, test_client, test_admin_authenticated):
    ...
    def test_list_roles_unauthorized(self, test_client, test_user_authenticated):
...
class TestListPermissions:
    ...
    def test_list_permissions_success(self, test_client, test_admin_authenticated):
    ...
    def test_list_permissions_unauthorized(self, test_client, test_user_authenticated):
...
class TestListRolesExpanded:
    ...
    def test_list_roles_includes_all_roles(self, test_client, test_admin_authenticated):
    ...
    def test_list_roles_sorted_by_level(self, test_client, test_admin_authenticated):
...
class TestListPermissionsExpanded:
    ...
    def test_list_permissions_includes_resources(self, test_client, test_admin_authenticated):
    ...
    def test_list_permissions_admin_has_all(self, test_client, test_admin_authenticated):
...
class TestAdminStats:
    ...
    def test_get_admin_stats_success(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_get_admin_stats_unauthorized(self, test_client, test_user_authenticated):
    ...
    def test_get_admin_stats_content_admin(self, test_client, test_db, content_admin_authenticated):
...
class TestAdminStatsExpanded:
    ...
    def test_get_admin_stats_with_chapters(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_get_admin_stats_empty_system(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_get_admin_stats_users_by_role(self, test_client, test_db, test_admin_authenticated):
...
class TestUpdateUserExpanded:
    ...
    def test_update_user_clearance_level(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_update_user_both_org_and_clearance(self, test_client, test_db, test_admin_authenticated):
...
class TestListUsersExpanded:
    ...
    def test_list_users_search_by_email(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_list_users_search_case_insensitive(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_list_users_pagination_page_2(self, test_client, test_db, test_admin_authenticated):
    ...
    def test_list_users_with_role_and_search(self, test_client, test_db, test_admin_authenticated):
...
class TestCreateUserExpanded:
    ...
    @patch("api.routes.admin.get_password_hash")
    def test_create_user_with_organization(self, mock_hash, test_client, test_db, test_admin_authenticated):
    ...
    @patch("api.routes.admin.get_password_hash")
    def test_create_user_default_role(self, mock_hash, test_client, test_db, test_admin_authenticated):
...
class TestRolesPermissionsExpanded:
    ...
    def test_list_roles_contains_permissions(self, test_client, test_admin_authenticated):
    ...
    def test_list_permissions_all_resources_have_actions(self, test_client, test_admin_authenticated):
